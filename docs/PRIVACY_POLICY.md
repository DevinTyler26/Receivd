...
- seller name;
- card names, product details, conditions, printings, prices, and ordered quantities;
- order totals;
...
Receivd does not ask for, collect, or store TCGplayer passwords, authentication cookies, authentication tokens, payment-card numbers, or bank information. It does not attempt to bypass TCGplayer authentication. Although a TCGplayer page may contain shipping or billing addresses, Receivd does not extract or store those addresses.
...
Questions about this policy can be sent to [dtyler.cunningham@gmail.com](mailto:dtyler.cunningham@gmail.com).
